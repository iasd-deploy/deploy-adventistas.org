...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/custom_finados2016/statics/css/style.css">
		...
		$imagem_video_principal = get_field('imagem_video_principal');
		$banner_a = get_field('banner_a');
		$banner_b = get_field('banner_b');
		$infografico_imagem = get_field('infografico_imagem');

		?>
		
	</head>

<body <?php body_class( array(WPLANG, $flavour_name, $aux, "finados2016") ) ?> >
	...
	<header>
		<div class="container">
			<div class="row">
				<div class="logo">
					<img src="<?php echo $titulo['url']; ?>" alt="<?php echo $titulo['alt']; ?>" class="img-responsive"/>
				</div>
			</div>
		</div>
	</header>
