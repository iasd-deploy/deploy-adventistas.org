...
class ProjetosController {
    ...
    public static function CreatePostType() {
        $labels = array(
            ...
            'singular_name' => __('Projetos', 'iasd'),
            'add_new' => __('Adicionar novo', 'iasd'),
            'add_new_item' => __('Adicionar novo projetos', 'iasd'),
            'edit_item' => __('Editar projetos', 'iasd'),
            'new_item' => __('Novo projetos', 'iasd'),
            'view_item' => __('Visualizar projetos', 'iasd'),
            'search_items' => __('Buscar projetos', 'iasd')
        );
    ...
    public static function MetaboxInfo() {
        return array(
            'id' => 'project-options',
            'title' => __('Opções de Exibição', 'iasd'),
            'post_type' => 'projetos',
            'context' => 'normal',
            'priority' => 'low',
            'fields' => array(
