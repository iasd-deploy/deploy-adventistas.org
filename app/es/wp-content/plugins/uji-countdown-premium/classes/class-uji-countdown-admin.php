...
class Uji_Countdown_Admin {
    ...
    * @var     string
    */
   protected $styles = array( 'classic', 'modern' );
   ...
   public function admin_tablelist() {
      ...
      if ( $this->saved_db_style() ) {
         ...
         echo '<ul>
                  ...
                  <li>
                     <img alt="security shield" src="'.UJICOUNTDOWN_URL.'assets/images/icon-mob.png">
                     <h3>Responsive</h3>
                  ...
                  <li>
                     ...
                     <p>Support â€œLeft to Rightâ€? to Arabic â€œRight to Leftâ€? </p>
                  </li>
                  <li>
   ...
   public function admin_countdown() {
      ...
      if ( $cur_style == 'modern' )
         $cnt .= $this->cform_sliderui( __( 'Timer Size:', $this->plugin_slug ), 'ujic_size', $vars['ujic_size'], 20, 160, 1 );
      if ( $cur_style == 'classic' )
      ...
      if ( $cur_style == 'modern' )
         $cnt .= $this->cform_color( __( 'Select Line Color:', $this->plugin_slug ), array( 'ujic_col_dw', 'ujic_col_up' ), array( __( 'Background', $this->plugin_slug ), __( 'Line', $this->plugin_slug ) ), array( $vars['ujic_col_dw'], $vars['ujic_col_up'] ) );
      if ( $cur_style == 'modern' )
         $cnt .= $this->cform_sliderui( __( 'Thickness:', $this->plugin_slug ), 'ujic_thick', $vars['ujic_thick'], 1, 50, 1 );
      if ( $cur_style == 'classic' )
      ...
      if ( $cur_style == 'modern' )
         $cnt .= $this->cform_color( __( 'Text Color:', $this->plugin_slug ), array( 'ujic_col_txt' ), array( __( 'Number Color', $this->plugin_slug ) ), array( $vars['ujic_col_txt'] ) );
   ...
   private function prev_metaboxes( $style, $countDownOptions ) {
      ...
      if ( $style == 'modern' ) {
         $prw = '<div id="ujiCountdown" class="ujic-' . $style . '">
                  <div class="ujiCountdown ujic_none ujicf" id="ujiCountdown2">
                  </div>
