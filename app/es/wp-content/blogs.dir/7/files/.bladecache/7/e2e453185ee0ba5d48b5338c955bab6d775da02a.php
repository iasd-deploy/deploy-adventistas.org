<?php if(is_admin()): ?>
	<img class="img-preview" src="<?php echo e(get_template_directory_uri()); ?>/Blocks/PAListDownloads/preview.png" alt="<?php echo e(__('Illustrative image of the front end of the block.', 'iasd')); ?>"/>
<?php else: ?> 
								...
								<div class="col-8">
									<div class="card-body p-0">
										...
										<?php if (! empty($item['title'])) : ?>
											<h3 class="card-title h6 m-0 pa-truncate-3"><?php echo $item['title']['rendered']; ?></h3>
										<?php endif; ?>
									</div>
								</div>
							</div>
...
<?php endif; ?>
<?php /**PATH /Users/clecyo.freitas/ComunicaDSA Dropbox/ComunicaDSA Dropbox/Clecyo l Freitas/Clecyo.Freitas/projetos/deploy-adventistas.org.git/app/es/wp-content/themes/pa-theme-sedes/Blocks/PAListDownloads/views/frontend.blade.php ENDPATH**/ ?>