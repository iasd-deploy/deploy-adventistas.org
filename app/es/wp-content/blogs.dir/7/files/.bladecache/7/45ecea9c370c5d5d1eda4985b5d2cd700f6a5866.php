<?php if(is_admin()): ?>
    <img class="img-preview" src="<?php echo e(get_template_directory_uri()); ?>/Blocks/PACarouselMinistry/preview.png" alt="<?php echo e(__('Illustrative image of the front end of the block.', 'iasd')); ?>" />
<?php else: ?>
...
<?php endif; ?>
<?php /**PATH /Users/clecyo.freitas/ComunicaDSA Dropbox/ComunicaDSA Dropbox/Clecyo l Freitas/Clecyo.Freitas/projetos/deploy-adventistas.org.git/app/es/wp-content/themes/pa-theme-sedes/Blocks/PACarouselMinistry/views/frontend.blade.php ENDPATH**/ ?>