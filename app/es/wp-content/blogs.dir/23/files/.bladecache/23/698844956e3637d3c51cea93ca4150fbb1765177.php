	...
	<div class="pa-widget pa-w-feliz7play py-4 col-12 position-relative bg-light mb-5">
		...
		<?php if (! empty($items)) : ?>
			<div class="row">
               ...
               data-autoplay="<?php echo e($active_autoplay); ?>"
               data-format="<?php echo e($display_format); ?>">
						...
						<?php if(count($items) > 1): ?>
							<div class="pa-slider-controle d-flex justify-content-between <?php echo e(! $nav_position ? 'justify-content-xl-center' : ''); ?> align-items-center mt-4">
								<div data-glide-el="controls" class="<?php echo e($nav_position); ?>">
...
<?php endif; ?>
<?php /**PATH /Users/clecyo.freitas/Documents/Dev_DSA/deploy-adventistas.org.git/app/es/wp-content/themes/pa-theme-sedes/Blocks/PAFeliz7Play/views/frontend.blade.php ENDPATH**/ ?>