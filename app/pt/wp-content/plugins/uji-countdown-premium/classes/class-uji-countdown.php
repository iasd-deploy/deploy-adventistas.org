...
class Uji_Countdown extends Uji_Countdown_Admin {
    ...
    public function enqueue_admin_scripts() {
        ...
        if ( $screen->id == $this->plugin_screen_hook_suffix && (isset($_GET['tab']) && $_GET['tab'] != "tab_ujic_list")) {
            ...
            if($_GET['tab'] != "tab_ujic_news")
            {
                ...
                wp_enqueue_script( $this->plugin_slug . '-admin-circle', UJICOUNTDOWN_URL . 'js/jquery.circles.js' );
            }
    ...
    public function enqueue_scripts() {
        ...
        wp_register_script( $this->plugin_slug . '-circles', UJICOUNTDOWN_URL . 'js/jquery.circles.js', array( 'jquery' ), $this->version );
