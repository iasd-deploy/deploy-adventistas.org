<?php if(is_admin()): ?>
	...
	<?php endif; ?>
<?php else: ?>
	<div class="pa-widget pa-w-list-videos col-12 mt-5 <?php echo e($block_format == '2/3' ? 'col-md-8' : 'col-md-4'); ?>">
		<?php if (! empty($title)) : ?>
			<h2><?php echo $title; ?></h2>
		<?php endif; ?>

		<?php if (! empty($items)) : ?>
			<div class="row row-cols-auto mt-4 mb-0 <?php echo e($block_format == '2/3' ? 'row-cols-md-2' : 'row-cols-md-1'); ?>">
...
<?php endif; ?>
<?php /**PATH /Users/isaltino/Git/deploy-adventistas.org/app/pt/wp-content/themes/pa-theme-sedes/Blocks/PAListVideos/views/frontend.blade.php ENDPATH**/ ?>