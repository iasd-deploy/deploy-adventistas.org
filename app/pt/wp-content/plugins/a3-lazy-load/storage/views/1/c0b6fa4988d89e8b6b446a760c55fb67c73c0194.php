<?php if(is_admin()): ?>
	...
	<?php endif; ?>
<?php else: ?>
	<div class="pa-widget pa-w-list-news col-12 mt-5 <?php echo e($block_format == '2/3' ? 'col-md-8' : 'col-md-4'); ?>">
		<?php if (! empty($title)) : ?>
									...
									<?php if (! empty($item['featured_media_url'])) : ?>
										<div class="ratio ratio-16x9">
											<figure class="figure m-xl-0">
												...
												/>
												<?php if(($block_format == '2/3' && isset($item['terms']['editorial']) && !empty($editorial = $item['terms']['editorial'])) ||
								...
								<div class="col-12 col-md-7">
									<div class="card-body p-0">
										<?php if (! empty($item['terms']['format'])) : ?>
											<span class="pa-tag text-uppercase d-none d-xl-table-cell rounded"><?php echo e($item['terms']['format']); ?></span>
										<?php endif; ?>

										<?php if (! empty($item['title'])) : ?>
											<h3 class="card-title mt-2 <?php echo e($block_format == '2/3' ? 'fw-bold h5' : 'h6 pa-truncate-3'); ?>"><?php echo $item['title']['rendered']; ?></h3>
										<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /Users/isaltino/Git/deploy-adventistas.org/app/pt/wp-content/themes/pa-theme-sedes/Blocks/PAListNews/views/frontend.blade.php ENDPATH**/ ?>