...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/custom_ss2015/css/style.css">
...
<body id="ss2015"  <?php body_class( array(WPLANG, $flavour_name, $aux) ) ?> >
	...
	<header>
		<div class="container">
			<div class="logo">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/custom_ss2015/img/<?php echo WPLANG; ?>/logo.png" class="img-responsive">
			</div>
		</div>
	</header>
