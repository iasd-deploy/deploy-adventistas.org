...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/custom_natal2015/statics/css/style.css">
...
<body <?php body_class( array(WPLANG, $flavour_name, $aux, "natal2015") ) ?> >
