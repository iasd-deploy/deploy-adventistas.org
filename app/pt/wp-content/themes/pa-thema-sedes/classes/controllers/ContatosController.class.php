...
class ContatosController {
    ...
    public static function CreatePostType() {
        $labels = array(
            'name' => __('Contatos', 'iasd'),
            'singular_name' => __('Contato', 'iasd'),
            'add_new' => __('Adicionar novo', 'iasd'),
            'add_new_item' => __('Adicionar novo contato', 'iasd'),
            'edit_item' => __('Editar contato', 'iasd'),
            'new_item' => __('Novo contato', 'iasd'),
            'view_item' => __('Visualizar contato', 'iasd'),
            'search_items' => __('Buscar contato', 'iasd')
        );
        ...
        $args = array(
            ...
            'labels' => $labels,
            'public' => true,
            'rewrite' => array('slug' => __('contatos', 'iasd')),
    ...
    public static function RegisterTaxonomies() {
        ...
        register_taxonomy( 'grupos_contatos', 'contatos', array(
                'hierarchical' => true,
                'label' => __( 'Grupos de Contatos', 'iasd' ),
                'show_ui' => true
            )
        );
    ...
    public static function MetaBoxInfo() {
        return array(
            'id' => 'info-contatos',
            'title' => __('Dados do Contato', 'iasd'),
            'post_type' => 'contatos',
            'context' => 'normal',
            'priority' => 'high',
            'fields' => array(
