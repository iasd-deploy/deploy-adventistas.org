...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/custom_10dias/css/style.css">
		<link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/custom_10dias/css/owl.carousel.css">
		<link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/custom_10dias/css/owl.theme.css">
...
<body id="oracao"  <?php body_class( array(WPLANG, $flavour_name, $aux) ) ?> >
	...
	<header>
		<div class="container">
			<div class="logo">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/custom_10dias/img/<?php echo WPLANG; ?>/logo.png" class="img-responsive">
			</div>
			<div class="seta">
				<a id="content" href="#content"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/custom_10dias/img/seta.png"> </a>
			</div>
		</div>
	</header>
