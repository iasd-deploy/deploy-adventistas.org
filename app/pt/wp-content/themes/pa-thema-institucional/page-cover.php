...
<div id="iasd-institutional-cover">
  <header class="iasd-institutional-header" style="background: url(<?php echo $thumb_url[0]; ?>)">    <div class="container">
      <figcaption class="col-sm-12">
      <h1><?php the_title(); ?> </h1>
      </figcaption>
    </div>
  </header>
  <div class="container iasd-institutional top-up">
    <section class="row">
