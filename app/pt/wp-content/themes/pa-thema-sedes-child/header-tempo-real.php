...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/custom_static/tempo-real/css/tempo-real.css?213">
		<meta property="og:url" content="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/custom_static/tempo-real/img/og.png" />
		...
		<style type="text/css">
			...
			body > footer {
				<?php if(get_field('bg_image_footer')): ?>
